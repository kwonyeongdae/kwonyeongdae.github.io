...
<div style="font-size : 17px; color:blue; margin-bottom: 7px">BookVO</div>
```java
@Component("book")
...
<div style="font-size : 17px; color:blue; margin-bottom: 7px">BookDAO</div>
```java
...
<div style="font-size : 17px; color:blue; margin-bottom: 7px">BookController</div>
```java
@Controller
@RequestMapping("/book")
...
<div style="font-size : 17px; color:blue; margin-bottom: 7px">Addfrom.jsp</div>
```html
...
<img src="/assets/images/king.png" width="600px" height="1000px" title="px(픽셀) 크기 설정" alt="RubberDuck"/><br>
...
<div style="font-size : 17px; color:blue; margin-bottom: 7px">BookMapper.xml</div>
```html
<!--책 추가 로직입니다 -->
...
<!--목록에서 같은 책을 추가하면 수량만 변경되서 추가 됩니다 -->
...
<div style = "font-size : 15px; margin-bottom: 7px">
3. Best는 베스트 셀러기능을 위해 sql문을 만들었습니다.</div>

<div style = "font-size : 15px; margin-bottom: 15px">
3. 목록에서 책을 장바구니에 추가할수 있습니다.</div>
...
<div style="font-size : 17px; color:blue; margin-bottom: 7px">list.jsp</div>
```html
<h3> fairy book's </h3>
...
<img src="/assets/images/admin.png" width="600px" height="200px" title="px(픽셀) 크기 설정" alt="RubberDuck"/><br>
...
<div style = "font-size : 15px; margin-bottom: 15px">
2. 상세페이지에서 책의 수량을 정해서 장바구니로 추가가 가능합니다.</div>

<div style="font-size : 17px; color:blue; margin-bottom: 7px">detail.jsp</div>
```html
<!--리뷰 출력 로직-->
...
<div style="font-size : 17px; color:blue; margin-bottom: 7px">Delete.jsp</div>
```html
<!-- 전체 삭제 로직 -->
