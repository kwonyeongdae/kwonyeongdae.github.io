...
<div style="font-size : 17px; color:blue; margin-bottom: 7px">BoardMapper.XML생성</div>
```html
...
<div style="font-size : 17px; color:blue; margin-bottom: 7px">BoardMapper와 BoardDAO생성</div>
```java
//Board Mapper
...
<div style="font-size : 17px; color:blue; margin-bottom: 7px">Board Controller생성</div>
```java
@Controller
...
<div style="font-size : 17px; color:blue; margin-bottom: 7px">ADDform 생성-jsp</div>
```html
...
<img src="/assets/images/con1입력.png" width="450px" height="300px" title="px(픽셀) 크기 설정" alt="RubberDuck"/><br>
<img src="/assets/images/ti1.png" width="450px" height="300px" title="px(픽셀) 크기 설정" alt="RubberDuck"/><br>
</div>
