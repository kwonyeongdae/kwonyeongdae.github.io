...
<img src="/assets/images/list.png" width="800px" height="250px" title="px(픽셀) 크기 설정" alt="RubberDuck" style ="float: left;"/>
<img src="/assets/images/num.png" width="800px" height="250px" title="px(픽셀) 크기 설정" alt="RubberDuck"/>
<img src="/assets/images/test.png" width="800px" height="250px" title="px(픽셀) 크기 설정" alt="RubberDuck"/>
<img src="/assets/images/name.png" width="800px" height="250px" title="px(픽셀) 크기 설정" alt="RubberDuck"style ="clear: left;"/ ><br>
</div>
<div style="font-size : 17px; margin-bottom: 15px">
