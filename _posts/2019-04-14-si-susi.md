...
<div style="font-size : 17px; margin-bottom: 7px">
검색기능을 활용해서 내가 원하는 게시물을 찾을수 있습니다.
<img src="/assets/images/list.png" width="400px" height="250px" title="px(픽셀) 크기 설정" alt="RubberDuck" style ="float: left;"/>
<img src="/assets/images/num.png" width="400px" height="250px" title="px(픽셀) 크기 설정" alt="RubberDuck"/>
<img src="/assets/images/test.png" width="400px" height="250px" title="px(픽셀) 크기 설정" alt="RubberDuck"/>
<img src="/assets/images/name.png" width="400px" height="250px" title="px(픽셀) 크기 설정" alt="RubberDuck"/ style ="clear: left;"><br>
</div>
<div style="font-size : 17px; margin-bottom: 15px">
문의 글을 보기위해선 비밀번호를 입력해야 합니다.
<img src="/assets/images/pass.png" width="400px" height="250px" title="px(픽셀) 크기 설정" alt="RubberDuck"/>
</div>
