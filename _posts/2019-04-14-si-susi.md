...
<div style = "font-size : 15px; margin-bottom: 10px;"><span style="font-weight: bold;">전체 코드</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:gray"> <https://github.com/kwonyeongdae/portfolio/tree/main/%EB%AC%B8%EC%9D%98%EC%82%AC%ED%95%AD/></span></div>
----------------------------------------------------
...
<img src="/assets/images/up2.png" width="400px" height="250px" title="px(픽셀) 크기 설정" alt="RubberDuck"/>
</div><br>
