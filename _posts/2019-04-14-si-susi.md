...
<div style = "font-size : 15px; margin-bottom: 10px;"><span style="font-weight: bold;">[전체 코드]</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:gray"> (https://github.com/kwonyeongdae/portfolio/tree/main/Board)</span></div>
----------------------------------------------------
